...
const RankedResumes = ({ resumeData, topCvs }) => {
  return (
    <div className="flex-grow p-8 relative">
      <h2 className="text-3xl font-poppinsBold text-[40px] text-customBlack mb-12 text-center">
        <span>Top {topCvs} Ranked</span>
        <span className="text-customBlue"> Resumes</span>
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {resumeData.map((resume, index) => (
          <div
